...
namespace Pear
{
    public partial class FormPearMac : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            {
                button1.Text = "Add to Cart $799.00";
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            if (Form1.instance.tb1.Text == "")
            {
                button2.Text = "Add to Cart $799.00";
        ...
        private void button6_Click(object sender, EventArgs e)
        {
            ...
            if (Form1.instance.tb1.Text == "")
            {
                button6.Text = "Add to Cart $799.00";
            ...
            else
            {
                ...
                string Queryss = "USE pearstoreProject; UPDATE cart SET total = total+799 WHERE userid = (SELECT userid FROM userinfo WHERE username = '" + Form1.instance.tb1.Text + "');";
                MySqlConnection MyConn2ss = new MySqlConnection(MyConnection3s);
        ...
        private void FormPearMac_Load(object sender, EventArgs e)
        {
