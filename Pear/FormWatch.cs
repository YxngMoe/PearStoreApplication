...
namespace Pear
{
    public partial class FormWatch : Form
    {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            {
                button2.Text = "Add to Cart $399.00";
            ...
            else
            {
                ...
                string Query5 = "USE pearstoreproject; SET foreign_key_checks = 0; INSERT INTO orders(orderid, productID, cartId) VALUES (NULL, (SELECT productID FROM products WHERE productname = 'pearwatchyellow'), (SELECT cartID FROM cart WHERE userid = (SELECT userid FROM userinfo WHERE username = '" + Form1.instance.tb1.Text + "'))); SET foreign_key_checks = 1;";
                ...
                string Queryss = "USE pearstoreProject; UPDATE cart SET total = total+399 WHERE userid = (SELECT userid FROM userinfo WHERE username = '" + Form1.instance.tb1.Text + "');";
        ...
        {
            button2.Text = "Added to Cart $399.00";
        }
